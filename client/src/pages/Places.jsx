                    ...
                    <form action="">
                        ...
                        <div className="flex gap-4 h-8">
                            <input
                                ...
                                className="w-full border rounded-2xl px-2"
                            />
                            <button className="bg-blue-500 rounded-xl text-nowrap text-white px-2">
                                Add Photos
                            </button>
                        </div>
                        ...
                        <div className="grid gap-2 sm:grid-cols-3 mb-2">
                            <div>
                                ...
                                <input type="text" placeholder="14:00" className="w-full border rounded-2xl px-2 py-1 mt-1"/>
                            </div>
                            <div>
                                <h3 className="mt-2 -mb-1">Check out time</h3>
                                <input type="text" placeholder="12:00" className="w-full border rounded-2xl px-2 py-1 mt-1"/>
                            </div>
                            <div>
                                <h3 className="mt-2 -mb-1">Max number of guest</h3>
                                <input type="text" placeholder="1 or more" className="w-full border rounded-2xl px-2 py-1 mt-1"/>
                            </div>
                        </div>
                        <button className="bg-blue-500 w-full text-white rounded-2xl h-10  my-4">Save</button>
                    </form>
                </div>
            )}
        </div>
